...
from dataflow.errors import CellNotFoundError, ManifestError
from dataflow.models.cells import CellEntry, CellType
...
class FileManager:
    ...
    def __init__(self, project_dir: Path) -> None:
        ...
        self.manifest_path = project_dir / "dataflow.yaml"
